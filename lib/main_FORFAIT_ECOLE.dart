            ...
            builder: (ctx, s) {
              ...
              return GridView.count(crossAxisCount:2, shrinkWrap:true,
                  ...
                  children:[
                    ...
                    StatCard(value:s.hasData?'${d!.encaisse}':'...',
                        label: user.role == UserRole.admin ? 'Revenu mensuel (FCFA)' : 'Forfait mensuel (FCFA)',
                        sub: user.role == UserRole.admin ? 'Forfaits ecoles' : 'Votre ecole',
        ...
        FutureBuilder<({int ecoles, int eleves, int abonnes, int encaisse, int impayes, int total})>(
          ...
          builder: (ctx, s) {
            ...
            return GridView.count(crossAxisCount:2, shrinkWrap:true,
                ...
                crossAxisSpacing:12, mainAxisSpacing:12, childAspectRatio:0.95,
                children:[
                  StatCard(value:s.hasData?'${d!.encaisse}':'...', label:'Revenu mensuel (FCFA)', sub:'Tous forfaits',
                      icon:Icons.payments_rounded, color:AppColors.green, iconBg:AppColors.greenBg),
            ...
            return Column(children: list.map((e)=> Container(
              ...
              child: Row(children:[
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children:[
                  ...
                  const SizedBox(height:2),
                  Text('${e.nb} eleves${e.corrige ? ' (ajuste)' : ''}  x  ${e.prix} F',
                      style: const TextStyle(fontSize:12, color: AppColors.textMuted)),
                ])),
                Text('${e.total} F',
