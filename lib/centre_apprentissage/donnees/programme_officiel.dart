...
class ProgrammeOfficiel {
  ...
  static const Map<String, List<ChapitreOfficiel>> _programmes = {
    ...
    '3e_math': [
      ChapitreOfficiel(1, 'Calcul littéral', 'Développement, réduction, factorisation et identités remarquables.'),
      ChapitreOfficiel(2, 'Propriétés de Thalès dans un triangle', 'Théorème de Thalès, réciproque et applications.'),
      ChapitreOfficiel(3, 'Racines carrées', 'Définition, propriétés et calculs avec les racines carrées.'),
      ChapitreOfficiel(4, 'Triangle rectangle', 'Théorème de Pythagore, réciproque et trigonométrie dans le triangle rectangle.'),
      ChapitreOfficiel(5, 'Calcul numérique', 'Calculs numériques, priorités et puissances.'),
      ChapitreOfficiel(6, 'Angles inscrits', 'Angles inscrits dans un cercle et propriétés associées.'),
      ChapitreOfficiel(7, 'Vecteurs', 'Notion de vecteur, égalité, opérations et applications.'),
      ChapitreOfficiel(8, 'Équations et inéquations dans ℝ', 'Résolution d’équations et d’inéquations dans les réels.'),
      ChapitreOfficiel(9, 'Pyramides et cônes', 'Patrons, aires et volumes des pyramides et cônes.'),
      ChapitreOfficiel(10, 'Statistique', 'Organisation, représentation et analyse de données statistiques.'),
      ChapitreOfficiel(11, 'Coordonnées de vecteurs', 'Coordonnées, opérations et applications des vecteurs dans le plan.'),
      ChapitreOfficiel(12, 'Équations de droites', 'Coefficient directeur, équations et positions relatives des droites.'),
      ChapitreOfficiel(13, 'Applications affines', 'Fonctions affines, représentations graphiques et applications.'),
      ChapitreOfficiel(14, 'Équations et inéquations dans ℝ × ℝ', 'Systèmes et représentation des solutions dans le plan.'),
    ],
    '2nde_A_math': [
